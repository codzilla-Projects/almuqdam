...
Redux::setSection(
	$opt_name, array(
		...
		'fields'     => array(
			...
			array(
				'id'       => 'header_one_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style One" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_two_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style Two" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_three_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style Three" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_six_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style six" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_seven_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style Seven" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_eight_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style eight" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_nine_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style Nine" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
			...
			array(
				'id'       => 'header_ten_header_sticky_background_color',
				'type'     => 'color_rgba',
				'title'    => esc_html__( 'Sticky Header Background Color', 'brixel' ),
				'subtitle' => esc_html__( 'Applies for sticky header. (Applies for header "Style Ten" only)', 'brixel' ),
				'default'  => array(
					'color' => '#ffffff',
					'alpha' => 1,
				),
	...
	$opt_name, array(
		...
		'fields'     => array(
			...
			array(
				...
				'default'  => array(
					'url' => get_template_directory_uri() . '/images/404-Error-Image.png',
				),
			),
